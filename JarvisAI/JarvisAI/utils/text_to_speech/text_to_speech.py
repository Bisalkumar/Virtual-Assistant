...
def text_to_speech(text, lang='en', backend_tts_api='gtts'):
    ...
    if backend_tts_api == 'gtts':
        ...
        try:
            ...
            # Using pygame to play the sound
            pygame.mixer.init()
            ...
            print(e)
            print("or You may have reached the free limit of 'gtts' API. Use 'pyttsx3' as backend for unlimited use.")
            return False
    else:
        # for pyttsx3 Backend
        engine = pyttsx3.init()
        ...
        try:
            ...
            if not os.path.exists(voice_file_name):
                cprint("You can try different voices. This is a one-time setup. You can reset your voice by deleting"
                       "'configs/Edith-Voice.txt' file in your working directory.",
                       color='blue')
                cprint("Your System Supports the Following Voices- ",
                       color='blue')
                voices_dict = {}
            ...
            print("Error occurred while creating config file for voices in pyttsx3 in 'text2speech'.",
                  "Contact the maintainer/developer of JarvisAI")
        try:
            ...
            print("Error occurred while using pyttsx3 in 'text2speech'.",
                  "or Your system may not support the pyttsx3 backend. Use 'gtts' as backend.",
                  "Contact the maintainer/developer of JarvisAI.")
            return False
